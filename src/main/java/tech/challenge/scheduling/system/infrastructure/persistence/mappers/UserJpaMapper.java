package tech.challenge.scheduling.system.infrastructure.persistence.mappers;
...
public class UserJpaMapper {
    ...
    public static UserJpaEntity toJpaEntity(User user) {
        ...
        if (user.getRoles() != null && !user.getRoles().isEmpty()) {
            ...
            HashSet<tech.challenge.scheduling.system.infrastructure.persistence.entities.RoleJpaEntity> roleSet = user
                    .getRoles().stream()
