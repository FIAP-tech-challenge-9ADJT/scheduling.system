...
public record CreateUserDTO(
        ...
        @NotBlank(message = "Email is required") @Email(message = "Email must be valid") @UniqueEmail String email,

        @NotBlank(message = "Login is required") @Size(min = 4, max = 50, message = "Login must have between 4 and 50 characters") @UniqueLogin String login,
